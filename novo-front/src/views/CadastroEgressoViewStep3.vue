...
import InformacoesPessoaisContato from '@/components/CadastroEgressoView/InformacoesPessoaisContato.vue'
  ...
  <div id="pageContainer">
    ...
    <main id="cadastrar-container">
      ...
      <form @submit.prevent="enviarDados">
        ...
        <InformacoesPessoaisContato v-bind:errors="[]"/>
        <!-- <InformacoesEgresso v-bind:errors="egressoValidationErrors ?? []" v-if="isEgresso()" /> -->
        <div id="form-button-container">
          <button class="button-primary" type="button">Retroceder</button>
